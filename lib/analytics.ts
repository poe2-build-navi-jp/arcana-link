...
export type AnalyticsEvent = 'card_page_view' | 'register_start' | 'register_complete' | 'match_found' | 'exchange_table_create' | 'share_x' | 'share_copy' | 'share_image' | 'share_url_view' | 'uid_copy' | 'listing_refresh' | 'revisit_match' | 'input_start' | 'input_complete_22' | 'match_search' | 'match_zero' | 'listing_publish' | 'listing_publish_success' | 'share_native' | 'shared_listing_view' | 'shared_listing_compare_start' | 'shared_listing_new_listing' | 'new_match_view' | 'trade_completed' | 'trade_completed_share' | 'quick_create_start' | 'quick_create_complete' | 'match_wait_register' | 'quick_start' | 'quick_complete' | 'trade_list_created' | 'match_wait_saved' | 'shared_url_visit' | 'shared_compare_start' | 'shared_compare_complete' | 'shared_user_registered' | 'perfect_match';
